with "provider_retrievability_weekly" as (
      select 
        date_trunc('week', "provider_retrievability_daily"."date")  as "week",
        ...
        (
            select "provider_url_finder_retrievability_daily"."success_rate"
            from "provider_url_finder_retrievability_daily"
            where "provider_url_finder_retrievability_daily"."provider" = "provider_retrievability_daily"."provider"
              and DATE_TRUNC('week', "provider_url_finder_retrievability_daily"."date") = DATE_TRUNC('week', "provider_url_finder_retrievability_daily"."date")
            order by "provider_url_finder_retrievability_daily"."date" desc
            limit 1
      ...
      group by "week", "provider_retrievability_daily"."provider"
)
select "week"                                      as "week",
