...
select case when $2 = true then avg("avg_weighted_retrievability_success_rate_http") else avg("avg_weighted_retrievability_success_rate") end as "average" -- httpRetrievability param $2
